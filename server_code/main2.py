...
def scan_process():
    ...
    try:
        ...
        boxes,recognised_text = imageProcessor(encoded_byte, min_confidence, min_area, adjustment_factor_x, adjustment_factor_y, offline_detection)
        
        # boxes = text_detection_v10.imageProcessor(encoded_byte, 0.2, 200, 0.2, 0.02)
        # if(len(boxes)>0):
        #    output = boxes.tolist()
        # else: 
        #     output = boxes
